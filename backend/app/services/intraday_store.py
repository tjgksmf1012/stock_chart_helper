...
class IntradayStore:
    """Small SQLite-backed cache for intraday bars.

    The store keeps normalized bars by (symbol, timeframe, datetime) so future
    providers such as KIS can write into the same persistence layer.
    """
