...
PATTERN_LIBRARY: list[PatternLibraryEntry] = [
    PatternLibraryEntry(
        ...
        volume_conditions=[
            ...
            "목선 돌파 때 거래량 증가가 동반되면 신뢰도가 높아집니다.",
        ],
        ...
        invalidation_conditions=[
            ...
            "돌파 후 목선 아래로 빠르게 복귀하면 재평가가 필요합니다.",
        ],
        cautions=[
    ...
    PatternLibraryEntry(
        ...
        volume_conditions=[
            ...
            "목선 이탈 시 거래량 증가가 확인되면 신뢰도가 높아집니다.",
        ],
        confirmation_conditions=[
    ...
    PatternLibraryEntry(
        ...
        structure_conditions=[
            ...
            "어깨 사이 저점을 연결한 목선이 비교적 선명해야 합니다.",
        ],
        volume_conditions=[
    ...
    PatternLibraryEntry(
        ...
        structure_conditions=[
            ...
            "각 반등 고점을 잇는 목선이 선명해야 합니다.",
        ],
        volume_conditions=[
            "오른쪽 어깨에서 매도 압력이 줄어드는 흐름이 바람직합니다.",
            "목선 돌파 때 거래량 증가가 동반되면 더 좋습니다.",
        ],
        confirmation_conditions=[
