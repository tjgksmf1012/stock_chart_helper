...
export const dashboardApi = {
  overview: (timeframe: Timeframe, limit = 30) => api.get<DashboardOverviewResponse>('/dashboard/overview', { params: { timeframe, limit } }).then(r => r.data),
  longHigh: (timeframe: Timeframe, limit = 30) => api.get<DashboardResponse>('/dashboard/long-high-probability', { params: { timeframe, limit } }).then(r => r.data),
  shortHigh: (timeframe: Timeframe, limit = 30) => api.get<DashboardResponse>('/dashboard/short-high-probability', { params: { timeframe, limit } }).then(r => r.data),
  highSimilarity: (timeframe: Timeframe, limit = 30) => api.get<DashboardResponse>('/dashboard/high-textbook-similarity', { params: { timeframe, limit } }).then(r => r.data),
  noSignal: (timeframe: Timeframe, limit = 30) => api.get<DashboardResponse>('/dashboard/watchlist-no-signal', { params: { timeframe, limit } }).then(r => r.data),
  armed: (timeframe: Timeframe, limit = 30) => api.get<DashboardResponse>('/dashboard/pattern-armed', { params: { timeframe, limit } }).then(r => r.data),
  forming: (timeframe: Timeframe, limit = 30) => api.get<DashboardResponse>('/dashboard/forming-candidates', { params: { timeframe, limit } }).then(r => r.data),
  ...
  cancelScan: (timeframe: Timeframe) => api.post<ScanStatusResponse>('/dashboard/scan-cancel', null, { params: { timeframe } }).then(r => r.data),
